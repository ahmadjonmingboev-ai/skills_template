...
function openDetailsModal(linkId) {
  ...
  requestAnimationFrame(() => {
    ...
    if (link.Link_Access_Instructions) {
...
function setupEventListeners() {
  ...
  document.getElementById('showAnalyticsBtn').addEventListener('click', showAnalyticsDashboard);
...
function toggleAnalytics() {
  ...
  if (content.style.display === 'none') {
    ...
    toggle.innerHTML = '<svg class="ll-icon ll-icon-sm"><use href="#icon-close"></use></svg>';
  } else {
    content.style.display = 'none';
    toggle.innerHTML = '<svg class="ll-icon ll-icon-sm"><use href="#icon-plus"></use></svg>';
  }
}
