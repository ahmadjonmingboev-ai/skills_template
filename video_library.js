...
function setFocusVideo(videoId) {
  ...
  const avatarUrl = video.Video_Author_Username ? userAvatarCache[video.Video_Author_Username] : null;
  ...
  if (descEl) {
    descEl.textContent = video.Video_Description || '';
  }
