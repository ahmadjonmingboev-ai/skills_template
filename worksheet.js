...
// ===== CONFIGURATION =====
const CONFIG = {
    confluenceBaseUrl: 'https://your-domain.atlassian.net/wiki',  // UPDATE THIS WITH YOUR CONFLUENCE URL
    pageId: '',
...
async function uploadAttachment(filename, fileContent) {
    try {
        ...
        if (existingAttachment) {
            // Update existing attachment - use attachment ID in the URL
...
function openConfigModal() {
    ...
    document.getElementById('configBaseUrl').value = CONFIG.confluenceBaseUrl || 'https://your-domain.atlassian.net/wiki';
